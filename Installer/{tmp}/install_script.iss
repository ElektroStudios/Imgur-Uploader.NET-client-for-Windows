...
#define AuthorWebsite "https://github.com/ElektroStudios/Imgur-Uploader.NET"
...
Root: HKCR; SubKey: SystemFileAssociations\.apng\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: apng
Root: HKCR; SubKey: SystemFileAssociations\.apng\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: apng
Root: HKCR; SubKey: SystemFileAssociations\.apng\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: apng
Root: HKCR; SubKey: SystemFileAssociations\.apng\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: apng

Root: HKCR; SubKey: SystemFileAssociations\.bmp\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: bmp
Root: HKCR; SubKey: SystemFileAssociations\.bmp\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: bmp
Root: HKCR; SubKey: SystemFileAssociations\.bmp\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: bmp
Root: HKCR; SubKey: SystemFileAssociations\.bmp\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: bmp

Root: HKCR; SubKey: SystemFileAssociations\.gif\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: gif
Root: HKCR; SubKey: SystemFileAssociations\.gif\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: gif
Root: HKCR; SubKey: SystemFileAssociations\.gif\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: gif
Root: HKCR; SubKey: SystemFileAssociations\.gif\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: gif

Root: HKCR; SubKey: SystemFileAssociations\.jpeg\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: jpeg
Root: HKCR; SubKey: SystemFileAssociations\.jpeg\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: jpeg
Root: HKCR; SubKey: SystemFileAssociations\.jpeg\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: jpeg
Root: HKCR; SubKey: SystemFileAssociations\.jpeg\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: jpeg

Root: HKCR; SubKey: SystemFileAssociations\.jpg\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: jpg
Root: HKCR; SubKey: SystemFileAssociations\.jpg\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: jpg
Root: HKCR; SubKey: SystemFileAssociations\.jpg\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: jpg
Root: HKCR; SubKey: SystemFileAssociations\.jpg\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: jpg

Root: HKCR; SubKey: SystemFileAssociations\.pdf\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: pdf
Root: HKCR; SubKey: SystemFileAssociations\.pdf\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: pdf
Root: HKCR; SubKey: SystemFileAssociations\.pdf\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: pdf
Root: HKCR; SubKey: SystemFileAssociations\.pdf\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: pdf

Root: HKCR; SubKey: SystemFileAssociations\.png\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: png
Root: HKCR; SubKey: SystemFileAssociations\.png\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: png
Root: HKCR; SubKey: SystemFileAssociations\.png\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: png
Root: HKCR; SubKey: SystemFileAssociations\.png\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: png

Root: HKCR; SubKey: SystemFileAssociations\.tiff\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: tiff
Root: HKCR; SubKey: SystemFileAssociations\.tiff\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: tiff
Root: HKCR; SubKey: SystemFileAssociations\.tiff\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: tiff
Root: HKCR; SubKey: SystemFileAssociations\.tiff\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: tiff

Root: HKCR; SubKey: SystemFileAssociations\.xcf\Shell\{#AppName}; ValueType: string; ValueName: MUIVerb; ValueData: {#AppName}; Flags: uninsdeletekey; Tasks: xcf
Root: HKCR; SubKey: SystemFileAssociations\.xcf\Shell\{#AppName}; ValueType: string; ValueName: SubCommands; ValueData: "{#ExeName}.Run;{#ExeName}.OpenFile"; Flags: uninsdeletekey; Tasks: xcf
Root: HKCR; SubKey: SystemFileAssociations\.xcf\Shell\{#AppName}; ValueType: string; ValueName: Icon; ValueData: {app}\{#ExeName}.Title.ico; Flags: uninsdeletekey; Tasks: xcf
Root: HKCR; SubKey: SystemFileAssociations\.xcf\Shell\{#AppName}; ValueType: string; ValueName: Position; ValueData: Middle; Flags: uninsdeletekey; Tasks: xcf

; Shell Commands
Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.Run; ValueType: string; ValueName: ; ValueData: Run {#AppName}; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf
Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.Run; ValueType: string; ValueName: icon; ValueData: {app}\{#ExeName}.Run.ico; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf
Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.Run\command; ValueType: string; ValueName: ; ValueData: {app}\{#ExeName}.exe; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf

Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.OpenFile; ValueType: string; ValueName: ; ValueData: Open file in {#AppName}; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf
Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.OpenFile; ValueType: string; ValueName: icon; ValueData: {app}\{#ExeName}.OpenFile.ico; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf
Root: HKLM; SubKey: SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\{#ExeName}.OpenFile\command; ValueType: string; ValueName: ; ValueData: """{app}\{#ExeName}.exe"" ""%1"""; Flags: uninsdeletekey; Tasks: apng or bmp or gif or jpeg or jpg or pdf or png or tiff or xcf

[Tasks]
Name: APNG; Description: *.apng; GroupDescription: Explorer's ContextMenu Integration:
Name: BMP; Description: *.bmp; GroupDescription: Explorer's ContextMenu Integration:
Name: GIF; Description: *.gif; GroupDescription: Explorer's ContextMenu Integration:
Name: JPEG; Description: *.jpeg; GroupDescription: Explorer's ContextMenu Integration:
Name: JPG; Description: *.jpg; GroupDescription: Explorer's ContextMenu Integration:
Name: PDF; Description: *.pdf; GroupDescription: Explorer's ContextMenu Integration:
Name: PNG; Description: *.png; GroupDescription: Explorer's ContextMenu Integration:
Name: TIFF; Description: *.tiff; GroupDescription: Explorer's ContextMenu Integration:
Name: XCF; Description: *.xcf; GroupDescription: Explorer's ContextMenu Integration:
